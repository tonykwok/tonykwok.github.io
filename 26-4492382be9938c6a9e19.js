            ...
            ;(s.prototype.THROTTLE_TIMEOUT = 100),
              ...
              (s.prototype._computeTargetAndRootIntersection = function (
                ...
                if ('none' != window.getComputedStyle(e).display) {
                  for (
                    var s, h, c, a, f, d, g, m, v = i, w = p(e), _ = !1;
                    !_ && w;

                  ) {
                    var b = null,
                      y = 1 == w.nodeType ? window.getComputedStyle(w) : {}
                    if ('none' == y.display) return null
                    if (w == this.root || 9 == w.nodeType)
                      if (((_ = !0), w == this.root || w == t))
                        o && !this.root
                        ...
                        var I = p(w),
                          T = I && u(I),
                          E =
                            I && this._computeTargetAndRootIntersection(I, T, r)
                        T && E
                          ? ((w = I), (b = l(T, E)))
                          : ((w = null), (v = null))
                      }
...
//# sourceMappingURL=26-4492382be9938c6a9e19.js.map
