;(window.webpackJsonp = window.webpackJsonp || []).push([
  [17],
  {
    Ofmp: function (e, l, t) {
      ...
      var St = { small: 16, medium: 32, large: 64 },
        yt = { top: 'text-top', middle: 'middle' },
        Nt = [16, 16]
      function wt(e) {
        var l = e.ariaLabel,
          t = e.children,
          ...
          z =
            'function' == typeof a
              ? c.default.createElement(a, null)
          ...
          i = {
            ...
            height: h,
            role: 'img',
            viewBox: [0, 0].concat(gt(r)).join(' '),
          }
        if (u && h) Object.assign(i, { width: u, height: h })
        else {
          var f = { width: r[0], height: r[1] },
            m = u ? 'width' : 'height',
            H = 'width' === m ? 'height' : 'width'
          ;(i[m] = u || h || St[v] || v), (i[H] = i[m] * (f[H] / f[m]))
        }
        return (
          (i.style = {
      ...
      var bt = wt,
        ...
        Gt = function (e) {
          ...
          return c.default.createElement(
            'div',
            { className: Ft.a.footer },
            1 == t.length &&
              c.default.createElement(
                jt,
                null,
                c.default.createElement('span', {
                  className: Ft.a.languageBadge,
        ...
        Ot = function (e) {
          ...
          return c.default.createElement(
            'div',
            { className: Ft.a.repository },
            c.default.createElement(Jt, { repo: l }),
      ...
      l.default = function (e) {
        ...
        return c.default.createElement(
          ...
          c.default.createElement(
            'main',
            { id: 'main', className: Dt.a.main },
            c.default.createElement(
              'div',
              { className: Dt.a.title },
              c.default.createElement(
                'h1',
                { className: Dt.a.heading },
            ...
            c.default.createElement(
              ...
              c.default.createElement(
                'h2',
                { className: Dt.a.subHeading },
                c.default.createElement('span', null, 'Featured work')
              ),
              c.default.createElement(
                'div',
                { className: Dt.a.gridList },
                n.map(function (e) {
                  var l = e.node,
                    n = l.id,
                    h = l.excerpt,
                    ...
                    z = a.image,
                    r = a.excerpt
                  return c.default.createElement(It.a, {
                    key: n,
                    title: v,
                    path: d,
                    author: u || t,
              ...
              h &&
                c.default.createElement(
                  'div',
                  null,
                  h.viewer.repositories.nodes
                    .map(function (e) {
                      return c.default.createElement(Ot, {
                        key: e.name,
                        repo: e,
                      })
                    })
...
//# sourceMappingURL=component---src-pages-work-js-ed1e16b607ff3668320d.js.map
